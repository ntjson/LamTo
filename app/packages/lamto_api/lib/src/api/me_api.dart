...
class MeApi {
  ...
  Future<Response<BuiltList<NotificationPreference>>> meNotificationPreferencesPartialUpdate({ 
    ...
    try {
      const _type = FullType(PatchedNotificationPreferenceUpdateRequest);
      _bodyData = patchedNotificationPreferenceUpdateRequest == null ? null : _serializers.serialize(patchedNotificationPreferenceUpdateRequest, specifiedType: _type);
    ...
    BuiltList<NotificationPreference>? _responseData;
    ...
    return Response<BuiltList<NotificationPreference>>(
      data: _responseData,
