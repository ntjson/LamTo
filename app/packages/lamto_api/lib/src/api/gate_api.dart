...
class GateApi {
  ...
  Future<Response<FaceEnrollment>> gateFaceCreate({
    ...
    final _path = r'/api/v1/gate/face';
    ...
    FaceEnrollment? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FaceEnrollment),
      ) as FaceEnrollment;
    ...
    return Response<FaceEnrollment>(
      data: _responseData,
  ...
  Future<Response<VehiclePlate>> gatePlatesCreate({
    ...
    final _path = r'/api/v1/gate/plates';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xLamToOccupancy != null) r'X-LamTo-Occupancy': xLamToOccupancy,
    ...
    try {
      const _type = FullType(PlateCreateRequest);
      _bodyData = _serializers.serialize(plateCreateRequest, specifiedType: _type);
    ...
    VehiclePlate? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(VehiclePlate),
      ) as VehiclePlate;
  ...
  Future<Response<void>> gatePlatesDestroy({
    ...
    final _path = r'/api/v1/gate/plates/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        if (xLamToOccupancy != null) r'X-LamTo-Occupancy': xLamToOccupancy,
  ...
  Future<Response<RecognitionOutcome>> gateRecognizeFaceCreate({
    ...
    final _path = r'/api/v1/gate/recognize/face';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RecognitionOutcome? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RecognitionOutcome),
      ) as RecognitionOutcome;
    ...
    return Response<RecognitionOutcome>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<RecognitionOutcome>> gateRecognizePlateCreate({
    ...
    final _path = r'/api/v1/gate/recognize/plate';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PlateRecognizeRequest);
      _bodyData = _serializers.serialize(plateRecognizeRequest, specifiedType: _type);
  ...
  Future<Response<GateRegistrations>> gateRegistrationsRetrieve({
    ...
    final _path = r'/api/v1/gate/registrations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xLamToOccupancy != null) r'X-LamTo-Occupancy': xLamToOccupancy,
    ...
    GateRegistrations? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GateRegistrations),
      ) as GateRegistrations;
    ...
    return Response<GateRegistrations>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
