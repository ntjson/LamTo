...
class AuthApi {
  ...
  Future<Response<void>> authLogoutCreate({
    ...
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xInstallId != null) r'X-Install-Id': xInstallId,
        ...?headers,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[
    ...
    try {
      const _type = FullType(LogoutInstallIdRequest);
      _bodyData = logoutInstallIdRequest == null ? null : _serializers.serialize(logoutInstallIdRequest, specifiedType: _type);
