...
class ProposalsApi {
  ...
  Future<Response<Proposal>> proposalDetail({ 
    ...
    final _path = r'/api/v1/proposals/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
  ...
  Future<Response<BuiltList<Proposal>>> proposalList({ 
    ...
    final _path = r'/api/v1/proposals';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xLamToOccupancy != null) r'X-LamTo-Occupancy': xLamToOccupancy,
  ...
  Future<Response<ProposalRatingResult>> proposalsRatingCreate({ 
    ...
    final _path = r'/api/v1/proposals/{id}/rating'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (xLamToOccupancy != null) r'X-LamTo-Occupancy': xLamToOccupancy,
    ...
    ProposalRatingResult? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProposalRatingResult),
      ) as ProposalRatingResult;
    ...
    return Response<ProposalRatingResult>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
