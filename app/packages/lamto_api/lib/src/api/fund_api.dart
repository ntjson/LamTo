...
class FundApi {
  ...
  /// * [range] - Chart range: 30d, 6m, or 12m. Defaults to 6m.
  ...
  Future<Response<FundSeries>> fundSeriesRetrieve({ 
    ...
    final _path = r'/api/v1/fund/series';
    ...
    FundSeries? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FundSeries),
      ) as FundSeries;
  ...
  Future<Response<FundSummary>> fundSummaryRetrieve({ 
    ...
    final _path = r'/api/v1/fund/summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (xLamToOccupancy != null) r'X-LamTo-Occupancy': xLamToOccupancy,
    ...
    FundSummary? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FundSummary),
      ) as FundSummary;
